$(function(){
    console.log('cy_test8.js has been called')
    graph_data = $('#graph-info8')[0].innerHTML.trim()
    var cy = window.cy = cytoscape({
        container: document.getElementById('cy8'),
